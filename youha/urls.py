...
from .views import highlightVidView,downloading,crawling,chatFlowView,chatFlowDetailView,audioFlowDetailView,topWordsDetailView,sentimentDetailView,TwitchChapterView,OriginalVidView
...
urlpatterns=[
    ...
    path('api/highlight/<int:pk>',views.highlightVidView.as_view()),
]
